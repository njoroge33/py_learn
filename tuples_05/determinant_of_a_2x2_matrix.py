...
# Write a function determinant(m, n), that takes in two tuples of exactly two elements each and returns the determinant of the 2x2 matrix formed by the tuples?
